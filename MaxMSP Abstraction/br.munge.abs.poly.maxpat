...
,
		"classnamespace" : "box",
		"rect" : [ -330.0, -1080.0, 1595.0, 1046.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 731.0, 736.0, 159.0, 127.0 ],
					"text" : "This delays a \"bang\" message based on the length of the grain's actual duration. When that time is up a message occurs that reopens the gate, turns  the gen~ player off, and then turns off the [adsr~] which will later mute the voie"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 720.0, 637.0, 151.0, 60.0 ],
					"text" : "This [/ 0.] is set up so it can determine the actual duration of the grain along with its speed. "
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 93.0, 139.0, 117.0, 22.0 ],
									"text" : "scale 0 100001 0. 1."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 93.0, 221.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 701.0, 527.0, 87.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 84.0, 139.0, 117.0, 22.0 ],
									"text" : "scale 0 100001 0. 1."
								}
...
,
					"patching_rect" : [ 454.799999999999955, 527.0, 75.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 303.0, 527.0, 70.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.0, 155.0, 150.0, 60.0 ],
					"text" : "This prevents a new bang message from coming in while the voice is processing"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 199.0, 148.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 100.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 239.0, 69.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 193.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 239.0, 100.0, 32.0, 22.0 ],
					"text" : "t 0 b"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 671.75, 855.0, 42.0, 22.0 ],
					"text" : "t 0 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 672.25, 756.0, 31.0, 22.0 ],
					"text" : "pipe"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 684.25, 657.0, 29.5, 22.0 ],
					"text" : "/ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 250.600000000000023, 506.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1000.25, 1096.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 240.0, 245.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 240.0, 289.0, 72.0, 22.0 ],
					"text" : "t b b b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1062.0, 1358.0, 68.0, 22.0 ],
					"text" : "pak 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1203.0, 1234.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1203.0, 1268.0, 45.0, 22.0 ],
					"text" : "mute 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 1062.0, 1313.0, 60.0, 23.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 769.0, 495.0, 173.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 735.0, 458.0, 173.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 635.0, 382.0, 195.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 615.600000000000023, 347.0, 195.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 406.799999999999955, 379.0, 199.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.600000000000023, 347.0, 199.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 33.0, 155.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : "On/Off"
					}
,
					"text" : "in 2 @attr_comment On/Off"
				}
...
, 							{
								"box" : 								{
									...
									"text" : "in 2 @comment On/Off @default 0 @min 0 @max 1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "in 4 @comment \"Grain Size 1\""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1037.5, 285.0, 286.0, 22.0 ],
									"text" : "in 2 @comment On/Off @default 0 @min 0 @max 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 363.0, 170.0, 29.5, 22.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 319.0, 170.0, 29.5, 22.0 ],
									"text" : "2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 185.5, 223.0, 68.0, 22.0 ],
									"text" : "selector~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 323.0, 99.0, 54.0, 22.0 ],
									"text" : "sel 3 5 6"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 234.5, 99.0, 46.0, 22.0 ],
									"text" : "rate~ 2"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 583.0, 153.0, 100.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 456.0, 153.0, 100.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 385.5, 144.0, 19.0, 22.0 ],
													"text" : "1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 355.5, 144.0, 19.0, 22.0 ],
													"text" : "0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 352.0, 229.0, 71.5, 22.0 ],
													"text" : "scale"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 415.0, 491.0, 53.0, 22.0 ],
													"text" : "clip 0. 1."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 416.0, 438.0, 117.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 192.0, 472.0, 53.0, 22.0 ],
													"text" : "clip 0. 1."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 193.0, 419.0, 117.0, 22.0 ],
													"text" : "scale 0. 0.59 0. 1. 2."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 595.5, 663.0, 29.5, 22.0 ],
													"text" : "*"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 136.0, 673.0, 29.5, 22.0 ],
													"text" : "*"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 417.0, 615.0, 40.0, 22.0 ],
													"text" : "slide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 438.0, 577.0, 70.0, 22.0 ],
													"text" : "mstosamps"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 438.0, 544.0, 19.0, 22.0 ],
													"text" : "5"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 191.0, 615.0, 40.0, 22.0 ],
													"text" : "slide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 212.0, 577.0, 70.0, 22.0 ],
													"text" : "mstosamps"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 212.0, 544.0, 19.0, 22.0 ],
													"text" : "5"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 415.0, 347.0, 116.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 193.0, 347.0, 130.0, 22.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 404.5, 545.0, 77.0, 22.0 ],
													"text" : "scale 0 1 1 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 788.0, 507.0, 26.0, 22.0 ],
													"text" : "< 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 787.0, 459.0, 35.0, 22.0 ],
													"text" : "delta"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 787.0, 411.0, 48.0, 22.0 ],
													"text" : "change"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 709.5, 526.0, 77.0, 22.0 ],
													"text" : "scale 0 1 1 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 360.5, 690.0, 47.0, 22.0 ],
													"text" : "clip 0 7"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 1095.5, 844.0, 40.0, 22.0 ],
													"text" : "slide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 1095.5, 786.0, 33.0, 22.0 ],
													"text" : "== 7"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 1065.5, 903.0, 40.0, 22.0 ],
													"text" : "mix"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 935.5, 860.0, 40.0, 22.0 ],
													"text" : "slide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 935.5, 802.0, 33.0, 22.0 ],
													"text" : "== 6"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 905.5, 919.0, 40.0, 22.0 ],
													"text" : "mix"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 459.0, 98.0, 40.0, 22.0 ],
													"text" : "slide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 776.5, 871.0, 40.0, 22.0 ],
													"text" : "slide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 776.5, 813.0, 33.0, 22.0 ],
													"text" : "== 5"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 746.5, 930.0, 40.0, 22.0 ],
													"text" : "mix"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 662.5, 871.0, 40.0, 22.0 ],
													"text" : "slide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 662.5, 813.0, 33.0, 22.0 ],
													"text" : "== 4"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 632.5, 930.0, 40.0, 22.0 ],
													"text" : "mix"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 521.0, 871.0, 40.0, 22.0 ],
													"text" : "slide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 521.0, 813.0, 33.0, 22.0 ],
													"text" : "== 3"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 491.0, 930.0, 40.0, 22.0 ],
													"text" : "mix"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 407.0, 871.0, 40.0, 22.0 ],
													"text" : "slide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 407.0, 813.0, 33.0, 22.0 ],
													"text" : "== 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 377.0, 930.0, 40.0, 22.0 ],
													"text" : "mix"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 267.0, 860.0, 40.0, 22.0 ],
													"text" : "slide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 267.0, 802.0, 33.0, 22.0 ],
													"text" : "== 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 237.0, 919.0, 40.0, 22.0 ],
													"text" : "mix"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 48.0, 860.0, 40.0, 22.0 ],
													"text" : "slide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 104.75, 829.0, 40.0, 22.0 ],
													"text" : "* 0.01"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 104.75, 786.0, 68.0, 22.0 ],
													"text" : "samplerate"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 48.0, 802.0, 33.0, 22.0 ],
													"text" : "== 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 18.0, 919.0, 40.0, 22.0 ],
													"text" : "mix"
												}
...
,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 237.75, 138.0, 51.0, 22.0 ],
																	"text" : "clip -1 0"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 239.75, 100.0, 48.0, 22.0 ],
																	"text" : "change"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 102.75, 428.0, 81.0, 22.0 ],
																	"text" : "scale -1 1 0 1"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 84.0, 344.0, 34.0, 22.0 ],
																	"text" : "latch"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 103.5, 394.0, 40.0, 22.0 ],
																	"text" : "mix"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 185.0, 300.0, 34.0, 22.0 ],
																	"text" : "latch"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 124.5, 243.0, 81.0, 22.0 ],
																	"text" : "scale 1 -1 0 1"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 124.5, 219.0, 27.0, 22.0 ],
																	"text" : "cos"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 124.5, 195.0, 26.0, 22.0 ],
																	"text" : "* pi"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 124.5, 40.0, 28.0, 22.0 ],
																	"text" : "in 1"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 239.75, 40.0, 28.0, 22.0 ],
																	"text" : "in 3"
																}
...
, 															{
																"box" : 																{
																	...
																	"numinlets" : 1,
																	"numoutlets" : 0,
																	"patching_rect" : [ 102.75, 510.0, 35.0, 22.0 ],
																	"text" : "out 1"
																}
...
,
													"patching_rect" : [ 1195.25, 478.0, 133.0, 22.0 ],
													"text" : "gen @title rand-smooth"
												}
...
,
													"patching_rect" : [ 1041.25, 478.0, 121.0, 22.0 ],
													"text" : "gen @title rand-ramp"
												}
...
,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 50.0, 139.5, 81.0, 22.0 ],
																	"text" : "scale 1 -1 0 1"
																}
...
, 															{
																"box" : 																{
																	...
																	"numinlets" : 1,
																	"numoutlets" : 0,
																	"patching_rect" : [ 50.0, 221.5, 35.0, 22.0 ],
																	"text" : "out 1"
																}
...
,
													"patching_rect" : [ 893.0, 478.0, 117.0, 22.0 ],
													"text" : "gen @title rand-step"
												}
...
,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 50.0, 209.5, 26.0, 22.0 ],
																	"text" : "> 0"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 50.0, 140.5, 29.5, 22.0 ],
																	"text" : "-"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 87.5, 100.0, 26.0, 22.0 ],
																	"text" : "!- 1"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 87.5, 40.0, 28.0, 22.0 ],
																	"text" : "in 2"
																}
...
, 															{
																"box" : 																{
																	...
																	"numinlets" : 1,
																	"numoutlets" : 0,
																	"patching_rect" : [ 50.0, 291.5, 35.0, 22.0 ],
																	"text" : "out 1"
																}
...
, 															{
																"patchline" : 																{
																	"destination" : [ "obj-24", 1 ],
																	"midpoints" : [ 97.0, 133.75, 70.0, 133.75 ],
																	"source" : [ "obj-9", 0 ]
																}
...
,
													"patching_rect" : [ 656.5, 478.0, 103.0, 22.0 ],
													"text" : "gen @title square"
												}
...
,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 50.0, 148.0, 81.0, 22.0 ],
																	"text" : "scale 1 -1 0 1"
																}
...
, 															{
																"box" : 																{
																	...
																	"numinlets" : 1,
																	"numoutlets" : 0,
																	"patching_rect" : [ 50.0, 230.0, 35.0, 22.0 ],
																	"text" : "out 1"
																}
...
,
													"patching_rect" : [ 178.0, 478.0, 88.0, 22.0 ],
													"text" : "gen @title sine"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 536.5, 505.0, 77.0, 22.0 ],
													"text" : "scale 0 1 1 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 28.5, 546.0, 25.0, 22.0 ],
													"text" : "0.5"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 376.0, 402.5, 93.5, 22.0 ],
													"text" : "triangle"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 893.0, 298.0, 37.0, 22.0 ],
													"text" : "noise"
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-4", 1 ],
													"midpoints" : [ 468.5, 225.5, 460.0, 225.5 ],
													"order" : 1,
													"source" : [ "obj-100", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-56", 1 ],
													"midpoints" : [ 468.5, 262.75, 750.0, 262.75 ],
													"order" : 0,
													"source" : [ "obj-100", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 915.0, 1007.0, 511.25, 1007.0 ],
													"source" : [ "obj-103", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-74", 0 ],
													"midpoints" : [ 1075.0, 999.0, 511.25, 999.0 ],
													"source" : [ "obj-106", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 370.0, 786.5, 945.0, 786.5 ],
													"order" : 1,
													"source" : [ "obj-110", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 370.0, 778.5, 1105.0, 778.5 ],
													"order" : 0,
													"source" : [ "obj-110", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-77", 0 ],
													"midpoints" : [ 370.0, 786.5, 57.5, 786.5 ],
													"order" : 7,
													"source" : [ "obj-110", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 370.0, 756.5, 276.5, 756.5 ],
													"order" : 6,
													"source" : [ "obj-110", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-87", 0 ],
													"midpoints" : [ 370.0, 792.0, 416.5, 792.0 ],
													"order" : 5,
													"source" : [ "obj-110", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 370.0, 792.0, 530.5, 792.0 ],
													"order" : 4,
													"source" : [ "obj-110", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-94", 0 ],
													"midpoints" : [ 370.0, 792.0, 672.0, 792.0 ],
													"order" : 3,
													"source" : [ "obj-110", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 370.0, 792.0, 786.0, 792.0 ],
													"order" : 2,
													"source" : [ "obj-110", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-60", 0 ],
													"midpoints" : [ 902.5, 398.5, 902.5, 398.5 ],
													"order" : 2,
													"source" : [ "obj-31", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 902.5, 398.5, 1101.75, 398.5 ],
													"order" : 1,
													"source" : [ "obj-31", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 902.5, 398.5, 1261.75, 398.5 ],
													"order" : 0,
													"source" : [ "obj-31", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 385.5, 444.75, 187.5, 444.75 ],
													"order" : 1,
													"source" : [ "obj-4", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-17", 0 ],
													"midpoints" : [ 28.0, 370.25, 546.0, 370.25 ],
													"order" : 3,
													"source" : [ "obj-5", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-4", 0 ],
													"midpoints" : [ 28.0, 387.5, 385.5, 387.5 ],
													"order" : 5,
													"source" : [ "obj-5", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-56", 0 ],
													"midpoints" : [ 28.0, 267.75, 666.0, 267.75 ],
													"order" : 2,
													"source" : [ "obj-5", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 28.0, 267.75, 1050.75, 267.75 ],
													"order" : 1,
													"source" : [ "obj-5", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 28.0, 267.75, 1204.75, 267.75 ],
													"order" : 0,
													"source" : [ "obj-5", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 666.0, 600.0, 833.375, 600.0, 833.375, 467.0, 1152.75, 467.0 ],
													"order" : 1,
													"source" : [ "obj-56", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 666.0, 599.0, 833.375, 599.0, 833.375, 467.0, 1318.75, 467.0 ],
													"order" : 0,
													"source" : [ "obj-56", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 797.5, 601.0, 833.25, 601.0, 833.25, 467.0, 1000.5, 467.0 ],
													"source" : [ "obj-7", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-74", 0 ],
													"midpoints" : [ 27.5, 1007.0, 511.25, 1007.0 ],
													"source" : [ "obj-76", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 724.0, 316.375, 724.0, 316.375, 87.0, 489.5, 87.0 ],
													"order" : 10,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 724.0, 311.125, 724.0, 311.125, 87.0, 479.0, 87.0 ],
													"order" : 11,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 855.0, 966.0, 855.0 ],
													"order" : 2,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 855.0, 955.5, 855.0 ],
													"order" : 3,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 861.0, 620.125, 861.0, 620.125, 833.0, 1126.0, 833.0 ],
													"order" : 0,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 861.0, 614.875, 861.0, 614.875, 833.0, 1115.5, 833.0 ],
													"order" : 1,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 855.0, 297.5, 855.0 ],
													"order" : 14,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 855.0, 287.0, 855.0 ],
													"order" : 15,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 860.5, 437.5, 860.5 ],
													"order" : 12,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 860.5, 427.0, 860.5 ],
													"order" : 13,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 860.5, 551.5, 860.5 ],
													"order" : 8,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 860.5, 541.0, 860.5 ],
													"order" : 9,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 860.5, 693.0, 860.5 ],
													"order" : 6,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 860.5, 682.5, 860.5 ],
													"order" : 7,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 860.5, 807.0, 860.5 ],
													"order" : 4,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 114.25, 860.5, 796.5, 860.5 ],
													"order" : 5,
													"source" : [ "obj-80", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-74", 0 ],
													"midpoints" : [ 246.5, 1007.0, 511.25, 1007.0 ],
													"source" : [ "obj-85", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-74", 0 ],
													"midpoints" : [ 386.5, 1012.5, 511.25, 1012.5 ],
													"source" : [ "obj-88", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-74", 0 ],
													"midpoints" : [ 500.5, 1012.5, 511.25, 1012.5 ],
													"source" : [ "obj-92", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-74", 0 ],
													"midpoints" : [ 642.0, 1012.5, 511.25, 1012.5 ],
													"source" : [ "obj-95", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-74", 0 ],
													"midpoints" : [ 756.0, 1012.5, 511.25, 1012.5 ],
													"source" : [ "obj-98", 0 ]
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 364.0, 174.0, 29.5, 22.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 320.0, 174.0, 29.5, 22.0 ],
									"text" : "2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 139.5, 320.0, 68.0, 22.0 ],
									"text" : "selector~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 324.0, 125.0, 34.0, 22.0 ],
									"text" : "sel 6"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 188.5, 196.0, 46.0, 22.0 ],
									"text" : "rate~ 2"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 573.0, 532.0, 90.0, 22.0 ],
													"text" : "scale 0. 1. 0. 2."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 502.0, 572.0, 90.0, 22.0 ],
													"text" : "scale 0. 1. 0. 1."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 192.0, 109.0, 90.0, 22.0 ],
													"text" : "scale 0. 1. 0. 2."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 121.0, 149.0, 90.0, 22.0 ],
													"text" : "scale 0. 1. 0. 1."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 454.0, 728.0, 77.0, 22.0 ],
													"text" : "scale 0 1 1 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 104.75, 823.0, 40.0, 22.0 ],
													"text" : "* 0.01"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 488.5, 494.0, 77.0, 22.0 ],
													"text" : "scale 0 1 1 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 28.5, 546.0, 19.0, 22.0 ],
													"text" : "1"
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-13", 0 ],
													"midpoints" : [ 468.5, 130.0, 335.0, 130.0, 335.0, 98.0, 201.5, 98.0 ],
													"order" : 3,
													"source" : [ "obj-100", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-17", 0 ],
													"midpoints" : [ 28.0, 370.25, 498.0, 370.25 ],
													"order" : 2,
													"source" : [ "obj-5", 0 ]
												}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 342.5, 1053.0, 659.5, 1053.0 ],
					"order" : 0,
					"source" : [ "obj-11", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 2 ],
					"midpoints" : [ 342.5, 937.5, 295.5, 937.5 ],
					"order" : 1,
					"source" : [ "obj-11", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 1 ],
					"midpoints" : [ 290.0, 937.5, 266.5, 937.5 ],
					"source" : [ "obj-11", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1090.0, 711.5, 342.5, 711.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"midpoints" : [ 302.5, 320.5, 1009.75, 320.5 ],
					"source" : [ "obj-24", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 249.5, 725.0, 681.75, 725.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-38", 0 ],
					"midpoints" : [ 270.699999999999989, 475.5, 312.5, 475.5 ],
					"source" : [ "obj-24", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-62", 0 ],
					"midpoints" : [ 291.899999999999977, 443.0, 710.5, 443.0 ],
					"source" : [ "obj-24", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 312.5, 568.0, 279.5, 568.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 692.75, 887.0, 475.625, 887.0, 475.625, 844.0, 258.5, 844.0 ],
					"source" : [ "obj-44", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 681.25, 1157.0, 1009.5, 1157.0 ],
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-51", 0 ],
					"midpoints" : [ 704.25, 891.0, 999.75, 891.0, 999.75, 137.0, 208.5, 137.0 ],
					"source" : [ "obj-44", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-38", 1 ],
					"midpoints" : [ 398.100000000000023, 430.0, 338.0, 430.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 464.299999999999955, 684.0, 300.5, 684.0 ],
					"order" : 1,
					"source" : [ "obj-56", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"midpoints" : [ 464.299999999999955, 585.0, 693.75, 585.0 ],
					"order" : 0,
					"source" : [ "obj-56", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 1 ],
					"midpoints" : [ 260.100000000000023, 690.0, 258.5, 690.0 ],
					"source" : [ "obj-59", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 416.299999999999955, 446.0, 363.5, 446.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 710.5, 558.0, 321.5, 558.0 ],
					"order" : 1,
					"source" : [ "obj-62", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 1 ],
					"midpoints" : [ 710.5, 585.0, 704.25, 585.0 ],
					"order" : 0,
					"source" : [ "obj-62", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-56", 1 ],
					"midpoints" : [ 625.100000000000023, 456.5, 492.299999999999955, 456.5 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-56", 2 ],
					"midpoints" : [ 644.5, 474.0, 520.299999999999955, 474.0 ],
					"source" : [ "obj-8", 0 ]
				}
